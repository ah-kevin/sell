...
import com.lennon.sell.utils.JsonUtil;
import com.lennon.sell.utils.MathUtil;
...
public class PayServiceImpl implements PayService {
    ...
    public PayResponse create(OrderDTO orderDTO){
        ...
        payRequest.setOrderAmount(Double.parseDouble("0.01"));
...
//        refundRequest.setOrderAmount(orderDTO.getOrderAmount().doubleValue());
        refundRequest.setOrderAmount(Double.parseDouble("0.01"));
